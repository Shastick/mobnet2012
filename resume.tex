...
\paragraph{Crypto enable tags possibilities}: Tree-approach, synchronization approach, hash chain based approach.
...
\begin{center}
\vspace{-10pt}
Values of $N$: 0,1,3,4,7,9,12,13,16,19,21,25,27,28,31,37,39,48,49,57,61,67,73,75,79,84,91,93,97
\end{center}
\vspace{-5pt}
\hrule
\vspace{-10pt}
